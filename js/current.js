...
jQuery(document).ready(function () {
    ...
    jQuery('#rd2').click(function () {
        jQuery('#modal_box').toggle();
        jQuery('#modal_box').css("left","28%");
    });
    jQuery('#rd3').click(function () {
        jQuery('#modal_box').toggle();
        jQuery('#modal_box').css("left","50%");

    });
    jQuery('#rd4').click(function () {
        jQuery('#modal_box').toggle();
        jQuery('#modal_box').css("left", "72%");
    });
    jQuery('#r5').click(function () {
        jQuery('#modal_box1').toggle();
        jQuery('#modal_box1').css("left", "28%");
    });
...
jQuery(document).ready(function () {
    ...
    $("#ajax-contact-form").submit(function () {
        ...
        $.ajax({
            type: "POST",
            url: "contact_form/index.aspx.cs",
            data: str,
